...
const config = {
  opening: {
    slug: 'sushi-prep-opening',
    title: 'Sushi Prep Opening Checklist',
    defaults: [{ content: 'Turn Lights On' }]
  },
  midday: {
    slug: 'sushi-prep-midday',
    title: 'Sushi Prep Mid Day Checklist',
    defaults: [{ content: 'Take Out Trash' }]
  },
  closing: {
    slug: 'sushi-prep-closing',
    title: 'Sushi Prep Closing Checklist',
