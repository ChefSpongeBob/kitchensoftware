<script>
  ...
  const lists = [
    { href: '/lists/checklists/kitchen/opening', title: 'Opening', description: 'Opening checklist tasks.' },
    { href: '/lists/checklists/kitchen/midday', title: 'Mid Day', description: 'Mid day checklist tasks.' },
    { href: '/lists/checklists/kitchen/closing', title: 'Closing', description: 'Closing checklist tasks.' }
  ];
</script>
