-- Add numeric tracking fields for preplist usage

ALTER TABLE list_items ADD COLUMN amount REAL NOT NULL DEFAULT 0;
ALTER TABLE list_items ADD COLUMN par_count REAL NOT NULL DEFAULT 0;

-- Seed starter preplist items so pages are immediately useful
